...
- **Strava's brand orange is `#FC5200`, not `#FC4C02`, and the difference costs a surface.**
  ...
  colour, `#FC5200`; the horizontal "Powered by Strava" PNG decodes to `#FC5200` on every
  opaque non-black pixel; and developers.strava.com/guidelines §3 names `#FC5200`. The cost:
